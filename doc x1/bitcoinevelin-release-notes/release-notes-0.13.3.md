bitcoinEvelin Core version 0.13.3 is now available from:

  <https://download.bitcoinevelin.org/bitcoinevelin-0.13.3/>
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/bitcoinevelin-project/bitcoinevelin/blob/0.13/src/chainparams.cpp#L214).
